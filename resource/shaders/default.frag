...
vec4 point_light(){
   ...
   for (int i = 0; i < MAX_LIGHTS; i++){
      ...
      float a = 0.7; // quadratic term, the bigger it is, the faster the light weakens in big distances
      float b = 0.7; // linear tearm, the bigger it is, the faster the light weakens in medium distances
